...
Canvas {
    ...
    property var    color:                  checked ? "green" : (child ? MyWindowsColor.mapIndicatorChild : MyWindowsColor.mapIndicator)
    ...
    property real   _gimbalYawRadius:   MyWindowItmeSize.defaultFontPixelHeight
    property real   _gimbalYawWidth:    _gimbalYawRadius * 2
    property real   _indicatorRadius:   small ? (MyWindowItmeSize.defaultFontPixelHeight * MyWindowItmeSize.smallFontPointRatio * 1.25 / 2) : (MyWindowItmeSize.defaultFontPixelHeight * 0.66)
