...
Item {
    ...
    signal          clicked()
    property real   radius:              MyWindowItmeSize.defaultFontPixelHeight * 1.25
    ...
    readonly property real _dropCornerRadius:   MyWindowItmeSize.defaultFontPixelWidth * 0.5
    ...
    Item {
        ...
        Canvas {
            ...
            onPaint: {
                ...
                context.closePath()
                context.fillStyle =MyWindowsColor.windowShade
                context.fill()
            }
        } // Canvas - arrowCanvas
