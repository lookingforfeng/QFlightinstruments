...
Rectangle {
    ...
    color:          "transparent"
    z:           MyWindowProperty.zOrderMapItems + 1    // Above item icons
    ...
    property bool _mobile:                  MyWindowItmeSize.isMobile
    property real _touchWidth:              Math.max(_itemIndicatorWidth, MyWindowItmeSize.minTouchPixels)
    property real _touchHeight:             Math.max(_itemIndicatorHeight, MyWindowItmeSize.minTouchPixels)
