...
Item {
   ...
   height: 50//rightEnd.y + MyWindowItmeSize.defaultFontPixelHeight
    ...
    CommonLabel {
        ...
        color:        mapControl.isSatelliteMap?"white":"balck"
        style:      Text.Outline
        styleColor: mapControl.isSatelliteMap?"balck":"white"
    ...
    Rectangle {
        ...
        anchors.left:   parent.left
        width:          2
        height:         MyWindowItmeSize.defaultFontPixelHeight
        color:          _color
    }
