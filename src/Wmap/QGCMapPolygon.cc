...
/*void QGCMapPolygon::saveToJson(QJsonObject& json)
{
    ...
    JsonHelper::saveGeoCoordinateArray(_polygonPath, false , jsonValue);
...
/*bool QGCMapPolygon::loadFromJson(const QJsonObject& json, bool required, QString& errorString)
{
    ...
    if (!JsonHelper::loadGeoCoordinateArray(json[jsonPolygonKey], false , _polygonPath, errorString)) {
        return false;
    }
...
double QGCMapPolygon::area(void) const
{
    ...
    return( 0.5 * fabs(coveredArea))/1000000;
}
