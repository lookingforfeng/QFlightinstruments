...
:   QGeoTiledMappingManagerEngine()
{
    ...
    mapTypes << QGCGEOMAPTYPE(QGeoMapType::HybridMap,         "GoogleChina Hybrid Map",          "GoogleChina hybrid map",                  false,  false,  UrlFactory::GoogleChinaHybrid);
